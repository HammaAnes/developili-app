...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: My_9th_question(),
    );
  }
}

class My_9th_question extends StatefulWidget {
  @override
  _My_9th_question_State createState() => _My_9th_question_State();
}

class _My_9th_question_State extends State<My_9th_question>
              ...
              Positioned(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      "Add Examples of Similar Applications",
                      style: TextStyle(
                        fontSize: 28,
