...
import 'Form_SRS_qst6.dart'; // Importez la page que vous souhaitez afficher après avoir cliqué sur un des premiers boutons
import 'Form_SRS_qst8.dart';
...
class _My_7th_question_State extends State<My_7th_question>
  ...
  final List<String> nomsBoutons = ["Yes", "No"];
  ...
  Future<void> _submitAnswer(String answer) async {
    ...
    try {
      ...
      final result = await APIService.submitAnswer(id, 15, answer,
  ...
  Future<void> _handleBackButton() async {
    ...
    try {
      ...
      String? user_id = await storage.read(key: "user_id");
      int? id = getUserId(user_id);
      final result = await APIService.deleteAnswer(id, 14,
              ...
              Positioned(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      "Would you like to have an interview with the developer before finalizing your choice?",
                      style: TextStyle(
                        fontSize: 28,
